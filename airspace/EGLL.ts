		...
		Generator.getInstance().airport(
			new Airport(
				...
				[
					...
					...new Array(3).fill(new Airport.EntryPoint(217, Generator.getInstance().beacon("BEGTO"), 16000)),
					...new Array(3).fill(new Airport.EntryPoint(213, Generator.getInstance().beacon("BEGTO"), 16000)),
